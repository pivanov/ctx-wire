...
const ITEMS = [
  ...
  },
  {
    ...
    a: "Command output, logs, and gain history stay local. Anonymous, aggregate telemetry is on by default (counts and bytes/tokens saved, bucketed by agent and country), never commands, arguments, paths, or output. `ctx-wire telemetry disable` drops only the per-command breakdown used to tune filters; community stats stay on.",
  },
  {
