...
const STEPS = [
  ...
  },
  {
    ...
    desc: "145 declarative filters shrink the output; secrets are scrubbed fail-closed; the full log stays on disk, and inspect shows exactly what was cut.",
  },
  {
    n: 3,
    title: "Short result",
